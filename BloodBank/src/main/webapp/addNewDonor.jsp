...
<body>
 ...
 {
 %>
 <center><font color ="red" size ="5">Successful</font></center>
 <%} %>
 ...
 {
 %>
 <center><font color ="red" size ="5">Some the went wrong</font></center>
 <%} %>
...
<div class="container">
      <form action="addNewDonorAction.jsp" method="post">
        ...
        <hr>
        <h2>Father Name</h2>
        <input type="text" placeholder="Enter Name" name="father">
        <hr>
        <h2>Mother Name</h2>
        <input type="text" placeholder="Enter Name" name="mother">
        <hr>
        <h2>Mobile Number</h2>
